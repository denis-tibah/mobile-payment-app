...
const countries2 = ISO3116CountryList2.filter((item) => {
  return !blackList.has(item.value);
});

const countryList = countries.sort((a, b) => a.name.localeCompare(b.name));

const countryList2 = countries2.sort((a, b) => a.value.localeCompare(b.value));
